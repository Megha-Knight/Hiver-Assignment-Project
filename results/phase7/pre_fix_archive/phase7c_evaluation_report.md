...
> **Timestamp (UTC)**: `2026-09-16T09:42:52.808230+00:00`  
...
| **Primary Response (Quality)** | Mean LLM-Judge Quality (Scale 1-5) | **4.29 / 5.0** | HIGH QUALITY |
| **Primary Grounding** | Evidence-Supported Response Rate | **99.50%** | PASS |
| **Authoritative Safety** | Deterministic Safety Violation Rate | **0.00%** | ZERO TOLERANCE (PASS) |
| **Strict Diagnostic** | Safety-Grounded Exact Match (SGEM) | **38.00%** | DIAGNOSTIC BASELINE |
...
- **Overall Exact Match All Rate**: `38.50%`
...
| :--- | :---: | :---: | :--- |
| **1. Relevance** | **4.73** | 5.0 | Laser-focused addressing customer issue |
...
- **Evidence-Supported Response Rate**: `99.50%` (199/200)
...
- **Review Packet Generated**: `data/evaluation/human_review_packet_n40.jsonl`
...
| `WRONG_ACTION` | 65 | Evaluated turn triggered diagnostic failure rule |
...
| `WEAK_EVIDENCE_GROUNDING` | 1 | Evaluated turn triggered diagnostic failure rule |
...
| `MULTI_ISSUE_CONVERSATION` | 26 | Evaluated turn triggered diagnostic failure rule |
...
- **Agent LLM Generation Mean Latency**: `0.41 ms`
- **Agent Deterministic Safety Latency**: `0.00 ms`
- **Total Real Agent Turn Latency**: `56.10 ms`
- **Judge Inference Mean Latency (Evaluation Overhead)**: `12.01 ms`
- **Total Evaluation Wall-Clock Duration**: `11.48 s`
